...
Nipple.prototype.stylize = function () {
    ...
    styles.front = {
        ...
        height: this.options.size / 4 + 'px',
        position: 'absolute',
        display: 'block',
        marginLeft: -this.options.size / 8 + 'px',
        marginTop: -this.options.size / 8 + 'px',
        background: this.options.colorP,
        'opacity': '.9',
        cursor:"all-scroll"
    };
...
Collection.prototype.createNipple = function (position, identifier) {
    ...
    var nipple = new Nipple(self, {
        ...
        position: position,
        zone: opts.zone,
        frontPosition: opts.frontPosition,
        colorP:opts.colorP
    });
